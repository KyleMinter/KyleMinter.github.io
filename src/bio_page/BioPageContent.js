...
export default function BioPageContent()
{
    return (
        <Container className="container-custom d-flex flex-column align-items-center">
            ...
            <div>
                <p>I'm a Full Stack Web Developer with experience in various languages and frameworks. In May 2025, I will graduate with a Bachelor's of Computer Science from the University of North Texas.</p>
                <br/>
